...
#define GFX_BL 32
#define BL_Freq 5000
unsigned int BL_Brightness = 100;
...
void TouchInit()
{
  ...
  Wire.begin(SCL,SDA);   //初始化IIC，设置引脚 SCL:21  SDA:22
...
void loop()
{
  ...
  if(!digitalRead(4) || !digitalRead(18) || !digitalRead(19) || !digitalRead(23))
  {
    DigitalDial_digital_clock_1_hour_value = 11;
    DigitalDial_digital_clock_1_min_value = 22;
    DigitalDial_digital_clock_1_sec_value = 00;
  }
